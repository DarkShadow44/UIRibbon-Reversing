...
int main()
{
    ...
    ok(uiribbon.unk6.ribbon.block1[0].block_type == UIRIBBON_BLOCK_TYPE_RIBBON_TABS, "Wrong blocktype");
    ok(uiribbon.unk6.ribbon.block1[0].block_tabs.tab_type == UIRIBBON_TAB_TYPE_NORMAL, "Wrong blocktype");
